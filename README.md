...
## What
A complete Terraform project deploying a VLESS+Reality proxy ([Xray-core](https://github.com/XTLS/Xray-core)) and a Psiphon Conduit relay ([Psiphon Conduit](https://github.com/Psiphon-Inc/conduit), donating bandwidth to Psiphon users) on a single low-cost host, with metrics sent to Grafana Cloud. The total cost is limited to the monthly cost of the Hetzner host.
